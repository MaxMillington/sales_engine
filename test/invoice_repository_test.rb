...
class InvoiceRepositoryTest < Minitest::Test
  ...
  def test_find_all_invoices_by_customer_id
    ...
    engine.start_up("./data/fixtures")
    inv = engine.invoice_repository
    assert_equal 4, inv.find_all_by_customer_id("1").count
  end
  ...
  def test_find_all_invoices_by_status
    ...
    engine.start_up("./data/fixtures")
    inv = engine.invoice_repository
    assert_equal 4, inv.find_all_by_status("shipped").count
  end
  ...
  def test_find_all_invoices_by_created_at
    ...
    engine.start_up("./data/fixtures")
    inv = engine.invoice_repository
    assert_equal 1, inv.find_all_by_created_at("2012-03-24 15:54:10 UTC").count
  end
  ...
  def test_find_all_invoices_by_updated_at
    ...
    engine.start_up("./data/fixtures")
    inv = engine.invoice_repository
    assert_equal 1, inv.find_all_by_updated_at("2012-03-24 15:54:10 UTC").count
  end
